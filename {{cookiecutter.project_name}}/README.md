...
[![codecov](https://codecov.io/github/{{cookiecutter.user}}/{{cookiecutter.project_name}}/branch/main/graph/badge.svg?token=6MQZ4LODE5)](https://app.codecov.io/github/{{cookiecutter.user}}/{{cookiecutter.project_name}})
